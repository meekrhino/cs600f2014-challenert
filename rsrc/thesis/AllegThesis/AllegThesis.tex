...
\hyphenation{itself repre-sen-tations linear state-ments}
...
\thesisnumber{CS15-02} % SEE PAULINE LANZINE TO GET YOUR REPORT NUMBER!
...
% ch:intro
\include{ch01_introduction} % Introduction -- of course, you can name it anything!

% ch:relatedwork
\include{ch02_relatedworknew} % Background, literature survey, ...

% ch:method
\include{ch03_methodofapproach} % Chapter organization is topic-dependent

%ch:implem
\include{ch04_results} % Chapter organization is topic-dependent

% YOU MAY HAVE SEVERAL MORE CHAPTERS, DEPENDING ON TOPIC AND ORGANIZATION

%ch:conclusion
\include{ch05_conclusion} % Conclusion/future work
...
\include{appa}  % Source code

\include{appb}  % Addendum 
